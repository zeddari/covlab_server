 ...
 */
@Service
public class PoMailService {
    private final Logger log = LoggerFactory.getLogger(PoMailService.class);
    ...
    @Autowired
    private JavaMailSender poMailSender;
