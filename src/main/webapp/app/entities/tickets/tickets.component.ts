...
export class TicketsComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.ticketsService
      ...
      .subscribe(
        (res: HttpResponse<ITickets[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInTickets(): void {
    this.eventSubscriber = this.eventManager.subscribe('ticketsListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ITickets[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
