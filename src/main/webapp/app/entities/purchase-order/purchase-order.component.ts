...
export class PurchaseOrderComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.purchaseOrderService
      ...
      .subscribe(
        (res: HttpResponse<IPurchaseOrder[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPurchaseOrders(): void {
    this.eventSubscriber = this.eventManager.subscribe('purchaseOrderListModification', () => this.loadPage());
  }
