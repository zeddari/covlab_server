...
import { PoStatusComponent } from 'app/entities/po-status/po-status.component';
...
describe('Component Tests', () => {
  describe('PoStatus Management Component', () => {
    let comp: PoStatusComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PoStatusComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.poStatuses && comp.poStatuses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
