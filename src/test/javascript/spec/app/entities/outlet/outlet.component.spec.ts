  ...
  describe('Outlet Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(OutletComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.outlets && comp.outlets[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
